...
void loop() {
  ...
  // Primeira posição - Garra abrindo
    ...
    // Segunda Posição - Motor Esquerdo vai levantar o braço
    ...
    delay(1000);
     // Quarta posição - Seria o motor Direito inclinando pegar o objeto
    ...
    // Quinta Posição - Garra fechando
    for (posicao = 79; posicao >= 60; posicao -= 1) {
        s4_garra.write(posicao);
        delay(10); // Ajuste o valor do atraso conforme necessário
    }
    delay(1000);
    ...
    // Sétima Posição - Garra abrindo e deixando o Objeto 
